...
ggplot(data = boot_diffprepost, 
       mapping = aes(x = stat)) +
  geom_histogram() +
  labs(title = "Bootstrap Distribution of difference in Proportions", subtite = "between pre and post implementations", y = "Frequency") +
    geom_vline(xintercept = 0.0210, color = "red") +
  geom_vline(xintercept = 0.155, color = "red")
```
...
We are 95% confident that the mean post-implementation positivity is 0.0210 to 0.155 higher than the  mean post-implementation positivity of pre-implementation.
